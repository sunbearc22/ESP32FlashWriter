...
3. You can use your keyboard "TAB" key to toggle between the fields in the GUI. Pressing the "RETURN" key will select the field. To exit the selected field, press the "ESCAPE" key. Scrolling within the "Port" and "Baud" fields can be done by pressing the "up" and "down" arrow keys. 
